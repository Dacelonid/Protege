...
public class CSVEntryToEntityTest {
    ...
    public void setup() {
        ...
        Property property = new Property.PropertyBuilder().name("has_annotation").functional().domain(new Entity("classes")).range(
                new Annotation("annotations")).build();
    ...
    public void convert_multipleCsvEntries_getEntitiesIncludingSubclasses() {
        ...
        Thing face_annotation = new Annotation(annotation, "Face_annotation");
        Thing eyes_annotation = new Annotation(annotation, "Eyes_annotation");
        Thing smile_annotation = new Annotation(annotation, "Smile_annotation");
    ...
    public void convert_wordsThatShouldntBeClasses_ideograph_shouldIgnoreThoseWords() {
        Thing parent = new Entity("ideograph");
        Thing ideograph6708 = new Entity(parent, "squared cjk unified ideograph-6708", Arrays.asList("japanese", "symbol", "word"));
        Thing japanese_annotation = new Annotation(annotation, "japanese_annotation");
        Thing symbol_annotation = new Annotation(annotation, "symbol_annotation");
        Thing word_annotation = new Annotation(annotation, "word_annotation");
    ...
    public void convert_wordsThatShouldntBeClasses_letter_shouldIgnoreThoseWords() {
        ...
        Thing a_annotation = new Annotation(annotation, "a_annotation");
        Thing blood_annotation = new Annotation(annotation, "blood_annotation");
        Thing symbol_annotation = new Annotation(annotation, "symbol_annotation");
        Thing word_annotation = new Annotation(annotation, "word_annotation");
    ...
    public void convert_multipleCSVEntriesWithMultipleClasses_shouldIgnoreAdjectives() {
        Thing face = new Entity(classes, "Face", Collections.singletonList("Face"));
        Thing smilingFace = new Annotation(face, "Smiling Face", Arrays.asList("Face", "Smile"));
        Thing face_annotation = new Annotation(annotation, "Face_annotation");
        Thing smile_annotation = new Annotation(annotation, "Smile_annotation");
    ...
    public void convert_annotationsWithSpaces_shouldConvertToUnderscores() {
        ...
        Thing smilingFace = new Annotation(face, "Smiling Face", Collections.singletonList("Smiling face"));
        Thing smile_annotation = new Annotation(annotation, "Smiling_face_annotation");
